...
const LowerExercises = () => {
    return ( 
        ...
        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/-LlGOh0Q9dM"
        ...
        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/3SyzSl6Oj-Y"
                            title="YouTube video player"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowFullScreen
                        ></iframe>
        ...
        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/PdEKzbBFZrE"
                            title="YouTube video player"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowFullScreen
                        ></iframe>
        ...
        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/2YyL9jtQ07s"
                            title="YouTube video player"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowFullScreen
                        ></iframe>
        ...
        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/rW22RnECiLk"
                            title="YouTube video player"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowFullScreen
                        ></iframe>
        ...
        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/NLGduAw_hB8"
                            title="YouTube video player"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowFullScreen
                        ></iframe>
