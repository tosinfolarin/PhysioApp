        ...
        <div className="table-container">
            <table className="custom-table">
                ...
                <tr>
                    ...
                    <td>Past history of trauma to cervical spine / cervical vessels, History of migraine-type headache, High blood pressure, High cholesterol levels, Cardiac disease, vascular disease, previous cerebrovascular accident or transient ischaemic attack, Diabetes, Blood clotting disorders, Anticoagulant therapy, Long-term use of steroids, History of smoking, Recent infection, Immediately post-partum, Head or neck trauma</td>
